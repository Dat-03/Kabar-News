            ...
            <TouchableOpacity style={styles.container} onPress={ClickNe}>
                ...
                <View style={styles.boxContent}>
                    ...
                    <View style={styles.boxEnd}>
                        <View style={styles.boxEnd}>
                            <View style={styles.boxEnd}>
                                <Image source={require('../image/logo.png')} style={styles.imageLogoNews} />
                                <Text style={styles.textName}>BBC News</Text>
                            </View>
                            <View style={[styles.boxTime, styles.boxEnd]}>
                                <Image source={require('../image/clocknew.png')} style={styles.imageClock} />
                                <Text style={styles.textTime}>14m ago</Text>
                            </View>
                        </View>
                        <Image source={require('../image/logo.png')} style={styles.imageVector} />
                    </View>
                </View>
            </TouchableOpacity>
        </View>
