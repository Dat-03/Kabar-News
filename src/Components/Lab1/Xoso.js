...
const Xoso = () => {
  ...
  const thongbao = (kq) => {
    if (kq == true) {
      setthongBao('Chúc mừng bạn đã trúng số vietlot 99 tỷ')
      setnumberChoose()
    }
    else {
      setthongBao('Chúc bạn may măn lần sau')
      setnumberChoose()
    }
  }
  return (
    <View>
      <Text style={styles.myTitle}>Xổ số</Text>
      <Text style={styles.myText}>Nhập số của bạn ( từ 0 đến 10): </Text>
      ...
      <Pressable style={styles.myPressableKetqua} onPress={ketqua}>
